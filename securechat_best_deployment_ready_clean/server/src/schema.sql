...
ALTER TABLE users ADD COLUMN IF NOT EXISTS languages VARCHAR(200) DEFAULT 'English';
...
CREATE TABLE IF NOT EXISTS user_sessions(
 ...
 device_name VARCHAR(160) NOT NULL DEFAULT 'Unknown device',
...
ALTER TABLE chat_preferences ADD COLUMN IF NOT EXISTS force_unread BOOLEAN NOT NULL DEFAULT FALSE;
...
CREATE TABLE IF NOT EXISTS flicks(
 ...
 created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
 deleted_at TIMESTAMPTZ);
ALTER TABLE flicks ADD COLUMN IF NOT EXISTS audience VARCHAR(20) NOT NULL DEFAULT 'contacts';
